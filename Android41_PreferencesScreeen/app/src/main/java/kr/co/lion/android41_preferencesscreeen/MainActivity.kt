...
import kr.co.lion.android41_preferencesscreeen.databinding.ActivityMainBinding

// PreferencesScreeen
// 환경 설정 기능을 구현할 수 있도록 하기 위해 제공되는 개념
// xml 파일을 통해 환경 설정화면을 구성하면 저장 기능까지 모두 구현되어 제공된다.
// 자세한 내용은 SettingFragment.kt 파일 참조
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityMainBinding.apply {
            button.setOnClickListener {
                replaceFragment(FragmentName.SETTING_FRAGMENT, false, false, null)
            }

            button2.setOnClickListener {
                replaceFragment(FragmentName.RESULT_FRAGMENT, false, false, null)
            }
        }
    }
