...
// 특별한 기능은 없고 화면이 구성될 때 그룹어 묶어서 보여주는 역할을 수행한다.
...
// defaultValue : 초기값, 반드시 entryValues 에 설정되어 있는 문자열 중에 하나를 넣어줘야 한다.
// key : 데이터를 가져올 때 사용하는 이름
// title : 화면에 보여지는 이름
// summary : 표시되는 설명
// icon : 좌측에 표시되는 아이콘
...
// defaultValue : 초기값, 반드시 entryValues 에 설정되어 있는 문자열 중에 원하는 것들을 모두 설정해준다.
// key : 데이터를 가져올 때 사용하는 이름
// title : 화면에 보여지는 이름
// summary : 표시되는 설명
// icon : 좌측에 표시되는 아이콘
