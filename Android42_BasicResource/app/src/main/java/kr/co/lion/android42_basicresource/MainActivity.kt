    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityMainBinding.apply {
            ...
            button.setOnClickListener{
                // res/values/strings.xml 에 등록한 문자열을 가져온다.
                val str1 = resources.getString(R.string.str1)
                textView.text = "${str1}\n"

                // 문자열은 프로그램에서 굉장히 많이 사용하는 요소이기 때문에 Activity에서
                // 등록된 문자열 리소스를 가져오는 메서드를 제공한다.
            ...
            button2.setOnClickListener {
                // res/values/string.xml 에 등록한 문자열을 가져온다.
                // str3 은 %s, %d, %f 등의 출력 양식을 가지고 있는 문자열이다.
                // 각 포멧 문자에 바인딩될 값을 지정해줘야 한다.
                val str1 = getString(R.string.str3)
                // % 부분에 바인될 값을 지정하여 문자열을 완성한다.
            ...
            button3.setOnClickListener {
                // res/values/strings.xml 에 등록된 문자열 배열을 가져온다.
