...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 권한 확인 필요한 일부 코드들은 권한 허용 어부를 검사해줘야 하는 것들이 있다.
        // checkSelfPermission : 두 번째 매개변수에 넣어준 권한이 허용되어 있는지...
        // PERMISSION_GRANTED : 허용된 권한
        // PERMISSION_DENIED : 거부된 권한
        val a1 = ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_SMS) == PackageManager.PERMISSION_GRANTED
        val a2 = ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) == PackageManager.PERMISSION_GRANTED
        val a3 = ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_NUMBERS) == PackageManager.PERMISSION_GRANTED
