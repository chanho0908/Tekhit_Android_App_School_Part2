    ...
    companion object{
        ...
        suspend fun selectContentData(contextIdx:Int):ContentModel?{
            ...
            val job1 = CoroutineScope(Dispatchers.IO).launch {
                ...
                val queryShapshot = collectionReference.whereEqualTo("contentIdx", contextIdx).get().await()
                ...
                // 프로퍼티에 필드의 값을 담아준다.
                contentModel = queryShapshot.documents[0].toObject(ContentModel::class.java)
            }
            job1.join()
