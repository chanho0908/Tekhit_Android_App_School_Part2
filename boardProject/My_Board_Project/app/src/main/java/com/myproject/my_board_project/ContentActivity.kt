...
import com.myproject.my_board_project.databinding.ActivityContentBinding
import com.myproject.my_board_project.databinding.HeaderContentDrawerBinding
import com.myproject.my_board_project.fragment.AddContentFragment
import com.myproject.my_board_project.fragment.MainFragment
...
class ContentActivity : AppCompatActivity() {
    ...
    fun settingNavigationView(){
        with(binding.navigationViewContent){
            // 헤더로 보여줄 View를 생성한다.
            ...
            setNavigationItemSelectedListener {
                ...
                when(it.itemId){
                    ...
                    R.id.menuItemContentNavigationAll -> {
                        ...
                        binding.drawerLayoutContent.close()
                    }
                    // 자유 게시판
